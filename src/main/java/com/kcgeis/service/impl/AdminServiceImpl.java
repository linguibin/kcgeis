...
import com.kcgeis.mapper.*;
import com.kcgeis.pojo.*;
import com.kcgeis.pojo.TbAdminExample.Criteria;
import com.kcgeis.service.AdminService;
...
public class AdminServiceImpl implements AdminService {
	...
	public List<Menu> selMenus(TbAdmin admin) {
		...
		com.kcgeis.pojo.TbRolesMenusExample.Criteria criteria = example.createCriteria();
	...
	public List<TbMenus> selXtreeData(TbAdmin admin) {
		...
		if(!roleId.equals(Long.valueOf("-1"))){
			...
			com.kcgeis.pojo.TbRolesMenusExample.Criteria criteria = rolemenusexample.createCriteria();
			criteria.andRoleIdEqualTo(roleId);
	...
	public TbRoles selRoleByRoleName(String roleName) {
		TbRolesExample example = new TbRolesExample();
		com.kcgeis.pojo.TbRolesExample.Criteria criteria = example.createCriteria();
	...
	public TbAdmin selAdminByUserName(String username) {
		TbAdminExample example = new TbAdminExample();
		com.kcgeis.pojo.TbAdminExample.Criteria criteria = example.createCriteria();
		criteria.andUsernameEqualTo(username);
	...
	public TbMenus selMenuByTitle(String title) {
		TbMenusExample example=new TbMenusExample();
		com.kcgeis.pojo.TbMenusExample.Criteria criteria = example.createCriteria();
