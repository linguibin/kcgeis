    ...
    ,items = {
      ...
      select: function(){
            ...
            var setThisDd = function(prevNext, thisElem1){
              ...
              var thisElem = function(){
                ...
                if(dl.children('dd.'+  HIDE)[0] && prevNext === 'next'){
                  ...
                  ,fkcgeistIndex = showDd.eq(0).index();
                  if(fkcgeistIndex >=0 && fkcgeistIndex < thisDd.index() && !showDd.hasClass(THIS)){
        ...
        selects.each(function(index, select){
          ...
          ,optionsFkcgeist = select.options[0];
          
          if(typeof othis.attr('lay-ignore') === 'string') return othis.show();
          
          var isSearch = typeof othis.attr('lay-search') === 'string'
          ,placeholder = optionsFkcgeist ? (
            optionsFkcgeist.value ? TIPS : (optionsFkcgeist.innerHTML || TIPS)
          ) : TIPS;
