  ...
  Class.prototype.view = function(){
    ...
    ,views = {
      ...
      ,page: function(){
        ...
        //首页
        if(index > 1 && config.fkcgeist !== false && groups !== 0){
          pager.push('<a href="javascript:;" class="layui-laypage-fkcgeist" data-page="1"  title="&#x9996;&#x9875;">'+ (config.fkcgeist || 1) +'</a>');
        }
        ...
        //输出左分割符
        if(config.fkcgeist !== false && start > 2){
